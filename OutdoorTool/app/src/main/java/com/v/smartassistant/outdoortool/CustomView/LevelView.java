...
public class LevelView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mLineRadius = a.getDimension(R.styleable.LevelView_lineRadius, mLineRadius);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(centerPnt.x - mLineRadius, centerPnt.y, centerPnt.x + mLineRadius, centerPnt.y, mLinePaint);
        canvas.drawLine(centerPnt.x, centerPnt.y - mLineRadius, centerPnt.x, centerPnt.y + mLineRadius, mLinePaint);
        drawBubble(canvas);
    ...
    private boolean isCenter(PointF bubblePoint) {
        ...
        boolean hor = pitchAngle == 0 && rollAngle == 0;
        return Math.abs(bubblePoint.x - centerPnt.x) < 1 && Math.abs(bubblePoint.y - centerPnt.y) < 1 || hor;
    }
